...
export default function BookmarkUI({ links, setEditBkmrkModal }){
        ...
        <div id='bookmark-ui'>

            {
                links.map((bookmark) => {
                    ...
                    const bookmarkCard = (
                            <Bookmarks key={id} id={id} name={name} url={url} tags={tags} clickCount={clicks} dateCreated={datecreated} dateModified={dateModified} comment={comment} lastAccessed={ lastAccessed } setEditBkmrkModal={ setEditBkmrkModal }/>
                    );
                    return bookmarkCard;
                })
            }
